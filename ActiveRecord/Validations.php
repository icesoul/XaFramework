...
class Errors implements IteratorAggregate
{
    ...
    public static $DEFAULT_ERROR_MESSAGES = array(
        'inclusion' => "этого значения нету в списке",
        'exclusion' => "зарезервировано",
        'invalid' => "не верно",
        'confirmation' => "не верно",
        'accepted' => "must be accepted",
        'empty' => "не может быть пустым",
        'blank' => "не может быть пустым",
        'too_long' => "максимальное кол-во символов равно %d)",
        'too_short' => "минимальное кол-во символов равно %d",
        'wrong_length' => "кол-во символов должно быть равно %d",
        'taken' => "has already been taken",
        'not_a_number' => "должно быть числовым значением",
